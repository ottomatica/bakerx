    ...
    (async () => {
        ...
        if( sync )
        {
            ...
            if (process.platform === 'win32') {
                ...
                if (!hasSymlink)
                    console.log(chalk.keyword(worange)('You do not have sufficient privilege to create symlinks. Please enable Developer mode in Windows 10 settings for better compatibility of --sync option.'));
                try {
